...
import com.wcdaren.database.dao.PhoneBookDao;
import com.wcdaren.database.dao.PhoneBookDerbyDao;
...
public class PhoneBookDerbyDaoTest {
    ...
    public void crates_phone_entry() throws Exception {
        ...
        verify(mockPrepStmt, new Times(3)).setString(intArgCaptor.capture(), stringArgCaptor.capture());
